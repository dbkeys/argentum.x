...
cd $BITCOIN_ROOT
./autogen.sh
./configure --disable-tests LDFLAGS="-L${BDB_PREFIX}/lib/" CPPFLAGS="-I${BDB_PREFIX}/include/" # (other args...)
```
...
with 5.1-built Bitcoin Core is needed follow the steps under "Berkeley DB" above.
