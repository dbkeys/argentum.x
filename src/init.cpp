...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    if (showDebug)
    {
        ...
        strUsage += HelpMessageOpt("-checkpoints", strprintf("Only accept block chain matching built-in checkpoints (default: %d)",DEFAULT_CHECKPOINTS_ENABLED));
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/argentumproject/argentum>";
    const std::string URL_WEBSITE = "<http://www.argentum.io>";
